...
const countMenu = () => {
	if (pageXOffset > 0 && pageYOffset < 100) {
		nav_ul.style.left = "-100%"
	}
}

const toggleButton = document.getElementsByClassName('menu_link')[0]
const navbarLinks = document.getElementsByClassName('nav__ul')[0]
...
// const scrollElem = () => {
// 	if(pageYOffset > 0 && pageYOffset < 250){
